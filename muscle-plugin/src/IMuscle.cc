...
void ITendon::StraightLineKinematics()
{
...
void ITendon::TangentPoints(math::Vector3& insertionP, math::Vector3& fixationP, math::Vector3& center, double radius)
{
...
double ITendon::WrappingAngle(double radius)
{
...
void ITendon::SphericalWrapping()
{
    ...
    {
        return StraightLineKinematics();
    }

    //compute tangent points
    TangentPoints(insertion, fixation, sphere.center, sphere.radius);
    ...
    double alpha = WrappingAngle(sphere.radius);
...
void ITendon::CylindricalWrapping()
{
    ...
    TangentPoints(p_insertion, p_fixation, cylinder.center, cylinder.radius);
    ...
    //calculate wrapping angle
    double alpha = WrappingAngle(cylinder.radius);
