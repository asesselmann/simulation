...
////////////////////
/// \brief A namespace in which all plugins must live.
namespace gazebo
{

	////////////////////
	/// \brief A MusclePlugin Class.
	///
	/// This class represents the ModelPlugin for Gazebo.
    ...
    public: void Init();
		...
		///
		/// This function loads the parameters for the plugin from the models' sdf file.
		/// \param[in] _parent A pointer to the model
		/// \param[in] _sdf A pointer to the sdf
    public: void Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf);

		////////////////////
		/// \brief The Update function
		///
		/// This function is called with every simulation update
